...
export const SYSTEMS: StrategySystem[] = [
  ...
  },
  {
    ...
    size: '₹10,00,000',
    since: '2 Sep 2026',
    rule: 'A close above the prior all-time-high close in an RS≥70, ₹5cr/day-liquid name → buy-stop at the pivot next day; −8% stop and 20-SMA trail; no entries while NIFTYBEES is under its 200-DMA.',
    rules: [
      ...
      ['Exits', 'Close ≤ 0.92× buy (stop) or close < SMA20 (trail — the after-tax winner over SMA50)'],
      ['Book', '8 slots, 18.75% of NAV each, RS-desc selection, 25bps/side, gate = NIFTYBEES 200-DMA'],
    ],
    ...
    changeLog: [{ date: '2 Sep 2026', text: 'G5 paper soak started at ₹10L on the adopted taxable spec (trail-20).' }],
