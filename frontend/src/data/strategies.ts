...
export const SYSTEMS: StrategySystem[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      ['Switch', 'OA_RULESET in services/oa_real.py: legacy (running) | baseage (staged). Entries paused 11-Sep-2026; Base Age entries staged 12-Sep-2026, switch OFF. BLOCKER before the flip: the 09:20 equity_executor OA top-up job must be pointed at the IPO book.'],
