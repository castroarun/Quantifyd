...
export const SYSTEMS: StrategySystem[] = [
  ...
  },
  {
    ...
    since: '2 Sep 2026',
    rule: 'STAGED 12-Sep-2026, switch OFF. First close above an all-time-high close that is at least 60 trading bars old and at least 20% above the low in between; 20-day traded value \u2265 \u20b92 cr; bought at the NEXT open. Exit: SuperTrend(14,4) on the close, sold at the next open. No stop, no time stop. 16 slots at 6.25% of NAV; contested slots go to the most liquid name. Until the flip the live book still runs the legacy \u22128% stop and 15-SMA trail, entries paused since 11-Sep-2026.',
    rules: [
