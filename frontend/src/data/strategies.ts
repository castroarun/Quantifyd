...
export const SYSTEMS: StrategySystem[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      ['Execution', 'AUTOMATED both sides since 08-Sep-2026. 15:18 check places its own exits (sell LIMIT floored 2% under the last price); 18:50 scan arms the next session\u2019s buy-stops at the pivot. A freed slot refills on the NEXT session, never the same day (research/157).'],
    ],
