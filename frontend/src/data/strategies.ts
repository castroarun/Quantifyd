...
export const SYSTEMS: StrategySystem[] = [
  ...
  },
  {
    ...
    size: '₹10,00,000',
    since: '2 Sep 2026',
    rule: 'A close above the prior all-time-high close in an RS≥70, ₹5cr/day-liquid name → buy-stop at the pivot next day; −8% stop and 20-SMA trail; no market gate (SMA200 retired 03-Sep-2026 after the gate bake-off).',
    rules: [
