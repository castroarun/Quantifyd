...
export const BACKTEST_STUDIES: BacktestStudy[] = [
  {
    ...
    cardStats: [
      { label: 'Verdict', value: 'STRATEGY-CANDIDATE' },
      { label: 'CAGR / MaxDD on Rs 36L', value: '11.47% / -13.8%' },
      { label: 'Calmar vs NIFTY', value: '0.83 vs 0.30' },
    ],
