      ...
      <section id="csl-paper" style={{ ...card, marginTop: 14, borderColor: C.pos, scrollMarginTop: 70 }}>
        ...
        <details style={{ margin: '6px 0 10px' }}>
          ...
          <div style={{ fontSize: 11.5, color: C.sec, marginTop: 6, lineHeight: 1.7 }}>
            ...
            <div style={{ marginTop: 6 }}><b>CSL_TIMEB_NIFTY (6 lots · qty 390 — sec-18b overweight):</b> the <b>optimized time-blocked book (TB-CSL)</b> — per-DTE entry→exit windows + SL from the Lab sweep, <b>frozen 13-AUG</b> (schedule above; weekly Lab regens do NOT move it). 2-unit weight per the portfolio scan.</div>
