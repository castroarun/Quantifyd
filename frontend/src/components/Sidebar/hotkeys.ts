 ...
 *
 * Mnemonics where the label allows (J journal, N nas, H holdings, M momentum portfolio,
...
export const PAGE_HOTKEYS: Record<string, string> = {
  ...
  // Holdings
  '/holdings': 'H',
  // M followed the momentum book here when the four books became tabs; the old
  // /momentum-paper route is now only a redirect and owns no sidebar row.
  '/portfolio': 'M',
  // Options
  '/options-study': 'O',
  '/options-data': 'D',
