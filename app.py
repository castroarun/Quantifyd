...
# ---- Breakout scanner: new ATHs, ATH+volume, consolidation breakouts ----
_bscan_cache = {}
...
# ---- Index Pulse: index strip / compare / drilldown ----
...
def api_nas_rules_matrix():
    ...
    try:
        ...
        _SLEEVE_LABELS = {
            ...
            'CSL_TIMEB2_NIFTY': '2nd-Slots · paper',
            'CSL_TIMEB2_LIVE': 'TimeB2 · expiry-Tue',
...
def nas_panic_legacy_redirect():
    return redirect('/app/nas-panic', code=302)
