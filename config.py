...
NAS_ATM_DEFAULTS = {
    ...
    'paper_lots_per_leg': 2,        # user 2026-07-13: PAPER books dropped 10 -> 2 lots (130 qty) to MATCH the live size, so paper and live P&L are directly comparable (was 10 from 2026-06-24, which put the paper book on a 5x scale vs live). Inherited by all 6 ATM via spread.  # 2026-08-05: user paper 2->3 (match live)  # 2026-08-13: user 3->2 (THE STACK, 2 lots per system)
...
NAS_916_ATM_DEFAULTS = {
    **NAS_ATM_DEFAULTS,
    'entry_start_time': '09:16',
    'lots_per_leg': 2,   # user 2026-07-07: LIVE 2 lots for 9:16 go-live (paper-shadow still paper_lots_per_leg=10)  # 2026-08-05: user 2->3 lots (whole NAS book to 3)  # 2026-08-13: user 3->2 (THE STACK, 2 lots per system)
}

NAS_916_ATM2_DEFAULTS = {
    **NAS_ATM2_DEFAULTS,
    'entry_start_time': '09:16',
    'lots_per_leg': 2,   # user 2026-07-07: LIVE 2 lots  # 2026-08-05: user 2->3 lots (whole NAS book to 3)  # 2026-08-13: user 3->2 (THE STACK, 2 lots per system)
}
