"""Generate static/ipo_paper_ohlc.json — daily OHLC for the IPO book holdings.

Same shape as momentum_ohlc.json so HoldingsCharts renders it unchanged. The
per-bar "stop" line is the book's actual exit level: the 20-SMA close trail,
...
OUT = f'{ROOT}/static/ipo_paper_ohlc.json'
DB = f'{ROOT}/backtest_data/market_data.db'
STATE = f'{ROOT}/backtest_data/ipo_paper_state.json'
DAYS = 400
TRAIL_N = 20
