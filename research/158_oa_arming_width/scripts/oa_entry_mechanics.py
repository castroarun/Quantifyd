...
def main():
    ...
    if a.entry_mode == 'open_next':
        # The stop rests overnight at the pivot broken yesterday. It fills only if
        # today the price actually reaches that pivot: a gap down that never recovers
        # is a MISS, the honest outcome the published mode never models.
