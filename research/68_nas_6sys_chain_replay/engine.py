...
def supertrend_up(prem_series, period=7, mult=2.0):
    """5-min OHLC SuperTrend on a leg's premium; True where trend UP (premium rising
...
def sim_day(day, entry_mode, mgmt, stop_mode="premium", move_pct=0.004,
            strike_offset=0, time_exit=DEFAULT_EXIT, allow_reentry=True):
    """Replay one day for one system. Returns list of closed-leg dicts."""
