# -*- coding: utf-8 -*-
# research/163: research/159 scripts/aftertax_all.py, byte-identical except CASH_Y 0.05 ->
# 0.052 and OUT redirected into research/163. research/159 is never written to.
...
OUT = ROOT / 'research/163_mpf_cash_yield_harmonisation/results/cash052/after_tax_tables_cash052.csv'
SEEDS = list(range(1, 31))
COST, SLOTS, SIZE, STOP = 0.0025, 16, 0.0625, 0.08
CASH_Y, STCG, LTCG = 0.052, 0.20, 0.125
