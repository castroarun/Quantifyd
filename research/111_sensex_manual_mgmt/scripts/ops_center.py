...
REVIEWS = [
    ...
    ('Holiday guard - first live holiday: did every Open Alpha / IPO / cash-park job skip on Mon 14-Sep-2026?', '2026-09-15', 'PENDING', 'Deployed 13-Sep (docs/HOLIDAY_GUARD_ALL_BOOK_JOBS_DEPLOY_STATUS.md). CHECK: "skipped - 2026-09-14 is not an NSE trading day" in /tmp/equity_executor.log (09:20), /tmp/cash_park.log (15:10), /tmp/oa_real.log (15:18), /tmp/ipo_paper.log (18:45), /tmp/oa_entry.log (18:50); no new Open Alpha order placed on 14-Sep; no 2026-09-14 point in oa_real_state.json navcurve; journalctl shows "[MP] EOD skipped" for True North at 15:05.'),
