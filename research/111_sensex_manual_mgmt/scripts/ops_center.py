...
REVIEWS = [
    ('research/169 - IPO Base: the live book runs MIN_BARS 60, not the validated 25. Decide BEFORE funding IPO at 25%', '2026-09-19', 'PENDING', 'research/169 (13-Sep-2026) transplanted IPO Spec A to Nifty-50/100/200/500/Midcap/Smallcap/all-stock universes: 0 of 16 beat their random-entry control, so IPO Base stays the only third sleeve. But services/ipo_paper.py runs MIN_BARS = 60 while research/167 validated 25 - the 6-Sep comment read the harness n >= 60 as bars at the signal date; it counts rows over the whole DB today. research/167 own engine: 21.80% after tax at 25, 11.57% at 60 (-38.97% DD). Inside TN 37.5 / OA 37.5 / IPO 25 the 60-bar book costs -2.46pp CAGR on 30/30 paths and beats risk-matched cash by only +0.61pp. OWED BY ARUN: decide MIN_BARS; if 25, open a strategy-change STATUS doc, check capacity for entries 25-60 sessions after listing (Spec A p90 position is 9.05% of 20-day traded value at Rs 10L - research/167 quoted the median 1.56% as the p90), deploy after 15:40, and update the Strategies register. PASS = a recorded MIN_BARS decision with the evidence line, before the 26-Sep funding call. Also read research/167 null edge as +2.25pp (2016-26: -0.18pp, 13/30), not +4.78pp. Evidence: research/169_ipo_rules_universe_transplant/results/RESULTS.md Q5-Q6.'),
