"""Walk-forward validation for the F&O EOD breakout system.
...
Reuses run_fno_backtest's engine (imports it).
"""
...
from run_fno_backtest import (   # type: ignore
...
# Mirror the validated winner-shape from research/19 plus baseline + a strict variant
TOP_VARIANTS = [
