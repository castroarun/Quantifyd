"""Walk-forward — Donchian 55-day breakout."""
...
from run_donchian_sweep import VARIANTS, signal_fn   # type: ignore
...
def main():
    ...
    if not top_names:
        top_names = ['baseline_55', '55_vol_3x_200sma', '55_vol_3x_confluence']
    ...
    print(f'{"Variant":>24} {"Phase":>5} {"Trades":>7} {"WR%":>6} {"PF":>6} '
    ...
    for cfg in cfgs:
        ...
        print(f'{cfg["name"]:>24} {"IS":>5} {is_m["trades"]:>7} {is_m["win_rate_pct"]:>6.1f} '
        ...
        print(f'{cfg["name"]:>24} {"OOS":>5} {oos_m["trades"]:>7} {oos_m["win_rate_pct"]:>6.1f} '
