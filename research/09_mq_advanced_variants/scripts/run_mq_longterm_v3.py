"""Run MQ PS30/PS20 long-term backtests WITH NiftyBEES 25% tranche + weekly cooldown."""
...
OUTPUT_CSV = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'mq_longterm_v3_tranche.csv')
...
configs = [
    # PS30 with 25% tranche weekly
    ('PS30_TRANCHE25W_2005_2025', 30, '2005-01-01', '2025-12-31'),
    ('PS30_TRANCHE25W_2010_2025', 30, '2010-01-01', '2025-12-31'),
    ('PS30_TRANCHE25W_2012_2025', 30, '2012-01-01', '2025-12-31'),
    ('PS30_TRANCHE25W_2015_2025', 30, '2015-01-01', '2025-12-31'),
    # PS20 with 25% tranche weekly
    ('PS20_TRANCHE25W_2005_2025', 20, '2005-01-01', '2025-12-31'),
    ('PS20_TRANCHE25W_2010_2025', 20, '2010-01-01', '2025-12-31'),
    ('PS20_TRANCHE25W_2012_2025', 20, '2012-01-01', '2025-12-31'),
    ('PS20_TRANCHE25W_2015_2025', 20, '2015-01-01', '2025-12-31'),
]
...
for i, (label, ps, start, end) in enumerate(configs):
    ...
    try:
        config = MQBacktestConfig(
            ...
            nifty_etf_deploy_pct=0.25,
            nifty_etf_deploy_interval='weekly',
        )
        ...
        print(f' {elapsed:.0f}s | CAGR={row["cagr"]:.2f}% Sharpe={row["sharpe"]:.2f} MaxDD={row["max_drawdown"]:.2f}% Calmar={row["calmar"]:.2f}')
        sys.stdout.flush()
