"""Run MQ PS30/PS20: NiftyBEES when ABOVE 200 SMA, debt when below (2-day confirm)."""
...
OUTPUT_CSV = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'mq_longterm_v4_above_sma.csv')
...
configs = [
    # PS30 - NiftyBEES above SMA, 2-day confirm
    ('PS30_ABOVE2D_2005_2025', 30, '2005-01-01', '2025-12-31'),
    ('PS30_ABOVE2D_2010_2025', 30, '2010-01-01', '2025-12-31'),
    ('PS30_ABOVE2D_2012_2025', 30, '2012-01-01', '2025-12-31'),
    ('PS30_ABOVE2D_2015_2025', 30, '2015-01-01', '2025-12-31'),
    # PS20 - NiftyBEES above SMA, 2-day confirm
    ('PS20_ABOVE2D_2005_2025', 20, '2005-01-01', '2025-12-31'),
    ('PS20_ABOVE2D_2010_2025', 20, '2010-01-01', '2025-12-31'),
    ('PS20_ABOVE2D_2012_2025', 20, '2012-01-01', '2025-12-31'),
    ('PS20_ABOVE2D_2015_2025', 20, '2015-01-01', '2025-12-31'),
]
