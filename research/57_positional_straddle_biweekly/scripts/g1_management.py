...
CONFIGS = [("no-mgmt", {}), ("move 1.0%", dict(move_pct=1.0)), ("move 1.5%", dict(move_pct=1.5)),
           ("move 2.0%", dict(move_pct=2.0)), ("move 2.5%", dict(move_pct=2.5)), ("move 3.0%", dict(move_pct=3.0)),
           ("PT 40%", dict(pt_pct=40)), ("PT 60%", dict(pt_pct=60)), ("PT 80%", dict(pt_pct=80)),
           ("move2.0+PT60", dict(move_pct=2.0, pt_pct=60))]
