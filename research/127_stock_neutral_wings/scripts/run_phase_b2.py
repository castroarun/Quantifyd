#!/usr/bin/env python3
"""research/127 Phase B2 — composite configs (per-axis winners combined), own backtest.
Reuses run_phase_b machinery. Output: results/phase_b2_trades.csv"""
...
OUT = RESULTS / "phase_b2_trades.csv"

CFGS = [
    ("C1_E45X21W7K25_noSL", dict(dte_entry=45, dte_exit=21, tp=0.50, sl=None, wing_pct=0.07, k=0.025)),
    ("C2_W10",              dict(dte_entry=45, dte_exit=21, tp=0.50, sl=None, wing_pct=0.10, k=0.025)),
    ("C3_ATM",              dict(dte_entry=45, dte_exit=21, tp=0.50, sl=None, wing_pct=0.07, k=0.0)),
    ("C4_E60",              dict(dte_entry=60, dte_exit=21, tp=0.50, sl=None, wing_pct=0.07, k=0.025)),
    ("C5_X15",              dict(dte_entry=45, dte_exit=15, tp=0.50, sl=None, wing_pct=0.07, k=0.025)),
]
